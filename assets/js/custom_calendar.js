 ...
 * customized by MyoungMinNam : 2020-05-29
 * 1) YYYY년 MM월 수정
 * 2) 접두어를 custom_ 로 변경
 */
 ...
 * @returns {*}
 */
$.fn.custom_calendar = function (options) {
	var opts = $.extend({}, $.fn.custom_calendar_defaults(), options);
	var languageSettings = $.fn.custom_calendar_language(opts.language);
	opts = $.extend({}, opts, languageSettings);

	this.each(function () {
		var $calendarElement = $(this);
		// reload 처리를 위해 주석처리 : 20200623
		// $calendarElement.attr('id', 'custom_calendar_' + Math.floor(Math.random() * 99999).toString(36));
		...
		function drawCalendar() {
			...
			var $containerHtml = $('<div class="custom_calendar"></div>');
 ...
 *   action_nav:        function
 */
$.fn.custom_calendar_defaults = function () {
	var now = new Date();
 ...
 */
$.fn.custom_calendar_language = function (lang) {
